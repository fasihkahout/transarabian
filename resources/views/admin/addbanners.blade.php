 ...
 @include('admin.head')
      ...
      @include('admin.sidebar')
       ...
       <section>
        <div class="container">
            <h5>Add Banner</h5>
  <form action="{{url('updatebanner',$updatebanner->id)}}" method="POST" class="my-4" enctype="multipart/form-data">
    @csrf
    <div class="row">
      <div class="col-sm-12 mx-12">
        ...
        <div class="form-group">
          ...
          <input type="text"  name="subtitle" class="form-control" value="{{$updatebanner->subtitle}}" id="cnic" placeholder="Enter your sub title">
        </div>
