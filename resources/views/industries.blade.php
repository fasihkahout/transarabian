...
<section class="page-header" style="margin-top:-10px">
    <div class="page-header__bg" style="background-image: url(assets/images/background/industries.jpg);"></div>
    <!-- /.page-header__bg -->
    <div class="container">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
                ...
                <div class="content mt-4">
                    <h3 class="title" style="color: black;text-align: center;font-weight: 600;">Civil Construction</h3>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
                ...
                <div class="content mt-4">
                <h3 class="title" style="color: black;text-align: center;font-weight: 600;">Petrochemical </h3>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
                ...
                <div class="content mt-4">
                <h3 class="title" style="color: black;text-align: center;font-weight: 600;">Medical Services</h3>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
                ...
                <div class="content mt-4">
                   <h3 class="title" style="color: black;text-align: center;font-weight: 600;">Agriculture</h3>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
                ...
                <div class="content mt-4">
                   <h3 class="title" style="color: black;text-align: center;font-weight: 600;">Security</h3>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
                ...
                <div class="content mt-4">
                    <h3 class="title" style="color: black;text-align: center;font-weight: 600;">Information Technology</h3>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
               <div class="">
                ...
                <div class="content mt-4">
                   <h3 class="title" style="color: black;text-align: center;font-weight: 600;">Public Utilities </h3>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
                ...
                <div class="content mt-4">
                    <h3 class="title" style="color: black;text-align: center;font-weight: 600;">Hospitality</h3>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
               <div class="">
                ...
                <div class="content mt-4">
                    <h3 class="title" style="color: black;text-align: center;font-weight: 600;">Logistics</h3>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
               <div class="">
                ...
                <div class="content mt-4">
                    <h3 class="title" style="color: black;text-align: center;font-weight: 600;">Administration</h3>
